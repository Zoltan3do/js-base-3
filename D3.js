...
let n = Math.floor(random * ((starWarsCharacters.length - 1)));
console.log(n);
stampa = "Nome: " + starWarsCharacters[n].name +
  ...
  "\nData di nascita: " + starWarsCharacters[n].birth_year +
  "\nGenere: " + starWarsCharacters[n].gender;
console.log(stampa);